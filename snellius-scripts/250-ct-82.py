...
def build_model(input_shape):
    ...
    x = layers.Dense(250 * 250 * 6, activation='relu')(x)
    output_layer = layers.Reshape((250, 250, 6))(x)
    
    model = models.Model(inputs=input_layer, outputs=output_layer)
    
    return model

input_shape = (sequence_length, 250, 250, 6)
...
df_all_timesteps.to_csv('CT-LSTM(250x250)(82-100hrs).csv', index=False)
...
output_dir = 'plots(250x250)/plots-CT-LSTM'
...
csv_filename = 'ct_250_82_loss_data.csv'
