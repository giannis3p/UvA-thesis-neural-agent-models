...
net = dde.maps.FNN([input_sequences_reshaped.shape[1]] + [500] * 3 + [output_values_reshaped.shape[1]], activation, "Glorot uniform")
...
df_all_timesteps.to_csv('PINN(500x500)(72-89hrs).csv', index=False)