...
def build_model(input_shape):
    ...
    x = layers.Dense(500 * 500 * 6, activation='relu')(x)
    output_layer = layers.Reshape((500, 500, 6))(x)
    
    model = models.Model(inputs=input_layer, outputs=output_layer)
    
    return model

input_shape = (sequence_length, 500, 500, 6)
...
df_all_timesteps.to_csv('CT-LSTM(500x500)(82-100hrs).csv', index=False)
...
output_dir = 'plots(500x500)/plots-CT-LSTM'
...
plot_filename = f'ct_82_loss.png'
...
csv_filename = 'ct_500_82_loss_data.csv'
